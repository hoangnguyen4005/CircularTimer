#
# Be sure to run `pod lib lint CircularTimer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/nguyenhoangit57/CircularTimer', :tag => s.version.to_s }

  s.ios.deployment_target = '11.0'
  s.source_files = 'CircularTimer/Classes/**/*'
end